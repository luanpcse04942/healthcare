                        ...
                        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                            <ul class="breadcrumb">
                                <li>
                                    ...
                                    <a href="<c:url value='/facility-home'/>">Trang chủ</a>
                                </li>
                                <li>
                                    <a href="<c:url value='/facility-patient-list'/>">Danh sách bệnh nhân</a>
                                </li>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 center">
                                        <span class="profile-picture">
                                            <img class="editable img-responsive" alt="alt="Avatar"  src="template/admin/assets/avatars/profile-pic.jpg" />
                                        </span>
                                    </div><!-- /.col -->
