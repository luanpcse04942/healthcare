                ...
                <div class="pagination">
                    <c:if test="${currentPage != 1}">
                        <c:choose>
                            <c:when test="${isSearching}">
                                <a href="doctor-list?search=${nameSearch}&page=${currentPage-1}">Trang trước</a>
                            </c:when>
                            <c:otherwise>
                                <a href="doctor-list?page=${currentPage-1}">Trang trước</a>
                            </c:otherwise>
                        </c:choose>
                    </c:if>
                    <c:forEach begin="1" end="${noOfPages}" var="i">
                        <c:choose>
                            ...
                            <c:when test="${isSearching}">
                                <a href="doctor-list?search=${nameSearch}&page=${i}">${i}</a>
                            </c:when>
                            <c:otherwise>
                                <a href="doctor-list?page=${i}">${i}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    <c:if test="${currentPage lt noOfPages}">
                        <c:choose>
                            <c:when test="${isSearching}">
                                <a href="doctor-list?search=${nameSearch}&page=${currentPage+1}">Trang sau</a>
                            </c:when>
                            <c:otherwise>
                                <a href="doctor-list?page=${currentPage+1}">Trang sau</a>
                            </c:otherwise>
                        </c:choose>
                    </c:if>
                </div>
