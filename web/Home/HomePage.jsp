<%-- 
    Document   : HomePage
    Created on : Sep 14, 2022, 2:05:21 PM
    Author     : LuanPC
--%>
    ...
    <body>
        ...
        <div class="grid-container">
                <div th:each="comic : ${comics}">
                        <div class="comic">
                                <div class="grid-img">
                                        <a th:href="@{/{tag}-{id}(tag=${comic.tag}, id=${comic.id})}">
                                                <img th:src="'/images/'+ ${comic.image}" width="186" height="238" alt="No image">
                                        </a>
                                </div>
                                <div class="grid-name" th:text="${comic.name}"></div>
                                <div class="grid-chapter" th:text="'Chương ' + ${comic.chapters}"></div>
                        </div>
                </div>
        </div>
        -->
